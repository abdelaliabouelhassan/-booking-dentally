<template>
    <DarkModel>
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    ...
                                    v-for="(item, index, key) in convestion"
                                    :key="key"
                                >
                                    <td
        ...
        <AddModal
            ...
            @updateConvestion="getConvestion"
        />
    </DarkModel>
</template>
    ...
    setup() {
        ...
        const getConvestion = async () => {
            ...
            const response = await axios
                .get(
                    `/convestion?practitioner=${practitioner.value}&search=${search.value}&tco=${TCO.value}&convention_user=${ConventionUser.value}&outcome=${Outcome.value}&date=${DateFilter.value}&page=${page.value}`
                )
                .then((response) => {
