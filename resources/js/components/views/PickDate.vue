        ...
        <template v-slot:body>
            ...
            <div class="p-10 space-y-8">
                ...
                <div class="bg-white rounded-t w-full">
                    <div
                        class="w-full card flex flex-col items-start space-y-6 h-full rounded-md"
                    >
                        ...
                        <div class="w-full grid grid-cols-7 gap-10">
                            <div
                                class="text-mainsublack text-sm font-normal flex flex-col relative"
                                :class="{
                                    'cursor-pointer':
                                        !item.past && !item.padding,
                                }"
                            ...
                            >
                                <div
                                    class="absolute w-6 h-6 rounded-full bg-gray-400 hover:bg-primary-100 flex"
                                ...
                                <div
                                    ...
                                    :class="{
                                        'text-mainsublack hover:bg-primary-100':
                                            !item.padding && !item.past,
                                        ' text-gray-200':
                                            item.padding || item.past,
                                        'bg-primary-100':
                ...
                <div v-if="ready">
                    <SlotsTimes
                        v-for="(date, index, key) in GroupByDate(
                    ...
                    />
                    <div
                        class="w-full flex py-10"
                        v-if="ready && appointments.availability.length <= 0"
                    >
                        <span class="m-auto text-sm font-bold text-black"
                            >No Available Times at this Date
                            {{ selectedDate }}</span
                        >
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    <ul
                        class="grid gap-4 grid-cols-1 text-center leading-tight"
                    >
                        <li>
                            <a
                                @click="nextAvailableSlot"
                                href="javascript:void(0)"
                                class="uppercase font-semibold tracking-10 flex p-2 rounded-full border border-theme-gray-light hover:border-theme-gold text-sm"
...
export default {
    ...
    methods: {
        ...
        load() {
            ...
            this.displayMonth = dt.toLocaleDateString("en-US", {
                month: "long",
            });
